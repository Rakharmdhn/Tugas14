        ...
        <ul className="flex items-center text-gray-800 dark:text-gray-400">
          ...
          <li>
            <button
              ...
              className="dark:text-gray-400 dark:hover:bg-slate-700 hover:bg-slate-200 border-2 border-white dark:border-gray-900 dark:hover:border-blue-800 active:border-2 active:border-blue-400 md:px-2 md:py-2 cursor-pointer text-lg items-center  ml-4 flex"
            >
